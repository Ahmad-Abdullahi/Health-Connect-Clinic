...
## 📁 Repository Files
* **[Power BI Dashboard File](HealthConnect_Initial_Dashboard_Abdullahi.pbix)** - The interactive `.pbix` file containing the data model, DAX measures, and visualizations.
